...
const (
	...
	KEYPRESS_OVERLAY       = "KEYPRESS_OVERLAY"       //nolint:revive
	KEYPRESS_OVERLAY_COLOR = "KEYPRESS_OVERLAY_COLOR" //nolint:revive
	KEYPRESS_OVERLAY_FONT  = "KEYPRESS_OVERLAY_FONT"  //nolint:revive
)
...
var Keywords = map[string]Type{
	...
	"KeypressOverlay":      KEYPRESS_OVERLAY,
	"KeypressOverlayColor": KEYPRESS_OVERLAY_COLOR,
	"KeypressOverlayFont":  KEYPRESS_OVERLAY_FONT,
	"true":            BOOLEAN,
	"false":           BOOLEAN,
	"Screenshot":      SCREENSHOT,
	"Copy":            COPY,
...
func IsSetting(t Type) bool {
	...
	case SHELL, FONT_FAMILY, FONT_SIZE, LETTER_SPACING, LINE_HEIGHT,
		...
		WINDOW_BAR_SIZE, BORDER_RADIUS, CURSOR_BLINK, KEYPRESS_OVERLAY,
		KEYPRESS_OVERLAY_COLOR, KEYPRESS_OVERLAY_FONT, WAIT_TIMEOUT, WAIT_PATTERN:
		return true
	default:
		return false
	}
